...
export default function AboutAPublisher() {
  return (
    <Section className="bg-beige text-red font-serif p-30">
      ...
      <div className="mb-30 col-span-12 3md:col-span-5 xl:col-span-4">
        <p>
          ...
          creation of custom editorial content, exhibitions, events, copywriting
          services and creative consulting.
        </p>
      </div>
      <div className="col-span-12 3md:col-span-7 xl:col-span-5">
        ...
        <p className="mb-42 indent">
          ...
          designer or the creative director of a fashion house. Entirely unique
          yet immediately recognisable with our signature ‘A’ cover design, each
          issue joins a canon of collectible magazines featuring some of the
          greatest names in 21st century avant-garde fashion.
        </p>
        <p className="mb-21 ">
        ...
        <p className="mb-42 indent">
          ...
          advertorial content, copywriting services and creative consulting for
          print and digital projects from the A MAGAZINE{" "}
