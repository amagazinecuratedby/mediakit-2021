  ...
  return (
    <Section className="col-span-12 py-30 border-t border-black gap-y-30">
      ...
      <div className="col-span-12 lg:col-span-5 2xl:col-span-4">
        <p className="mb-24">
          In recent years, a solid partnership with global distributors has been
          complimented by new direct retailer relationships with art and design
          bookstores, concept stores, museum shops and other multi-brand
          retailers worldwide.
        </p>
        <p>
          These strong connections enable a greater presence in local markets,
          especially in secondary locations that are growing focal areas for us
          in a time where online shipping costs from Europe remain prohibitive
          for readers in the far reaches of the globe. These partnerships
          continue to generate local marketing activations and events outside of
      ...
      <div className="col-span-12 lg:col-span-7 2xl:col-span-4 grid grid-cols-8 gap-x-12 text-21 leading-27">
        <ul className="col-span-8 sm:col-span-4">
          ...
          <li>
            Dorbeetle Studio – <span className="italic">China (online)</span>
          </li>
          <li>
          ...
          <li>
            Import News – <span className="italic">NYC, LA, San Francisco</span>
          </li>
          <li>
