      ...
      <AnimatePresence>
        {isActive && (
          ...
          >
            ...
            <div className="col-span-12 lg:col-span-6 grid grid-cols-4 xs:grid-rows-3 sm:grid-rows-2 gap-x-30 gap-y-30">
            ...
            <div className="col-span-12 grid grid-cols-8 gap-x-30 gap-y-30">
